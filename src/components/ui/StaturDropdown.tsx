    ...
    >
      ...
      {isOpen && (
        <div
          ...
          className="absolute top-full left- mt-px z-50
          min-w-24 max-h-70 overflow-y-auto scrollbar-none
        ...
        >
          {options.map((option) => (
            <div
              ...
              className="h-10 flex items-center justify-start px-2 py-2.5
              font-consolas font-normal text-xs text-(--text-primary) leading-normal
              border border-(--bg-border) hover:bg-[#1B1B1B]"
            >
              {option}
            </div>
          ))}
